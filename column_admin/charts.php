      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <p>Full documentation for morris.js charts can be found at <a href="http://www.oesmith.co.uk/morris.js/" target="_blank">http://www.oesmith.co.uk/morris.js/</a>. The chart options for morris.js are <a href="http://www.oesmith.co.uk/morris.js/lines.php" target="_blank">line &amp; area charts</a>, <a href="http://www.oesmith.co.uk/morris.js/bars.php">bar charts</a>, and <a href="http://www.oesmith.co.uk/morris.js/donuts.php" target="_blank">donut charts</a>. The documentation is pretty straight forward, and you will want to look at it in order to get the most out of the charts.</p>
